...
import LPSI1 from "../assets/LPSI1.png";
import LPSI2 from "../assets/LPSI2.png";
  ...
  return (
    <>
      <div className="bg-gray-50">
        <h1 className="text-center text-7xl sm:text-9xl font-extrabold text-black pt-[100px]">
        ...
        <section className="relative py-12 sm:py-16 lg:pb-40">
          ...
          <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* Left Content */}
              <div className="text-center lg:text-left md:px-16 lg:px-0 xl:pr-20">
                <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl lg:text-6xl">
                  Where Behavior Becomes Identity.
                </h1>
                <p className="mt-2 text-lg text-gray-600 sm:mt-6">
                  Behavioral biometrics is a method of identity verification
                  that analyzes unique patterns in human interactions with
                  digital devices, such as typing speed, mouse movements,
                  touchscreen gestures, and voice characteristics. Unlike static
                  authentication methods, it provides continuous, adaptive
                  security by monitoring real-time behavioral traits to detect
              ...
              {/* Right Image */}
              <div>
                <img className="w-full mx-auto" src={LPSI2} alt="" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                <h1 className="text-center text-4xl sm:text-5xl font-extrabold text-black pt-[100px]">
                  Behavioral Biometrics
                </h1>
              </a>
            </div>
